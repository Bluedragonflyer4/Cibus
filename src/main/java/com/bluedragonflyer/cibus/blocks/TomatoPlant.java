...
public class TomatoPlant extends BushBlock implements IGrowable{
    ...
    protected IItemProvider getBaseSeedId() { return RegistryHandler.TOMATO_SEED.get();
    }

    public TomatoPlant(AbstractBlock.Properties p_i48421_1_) {
        super(p_i48421_1_);
