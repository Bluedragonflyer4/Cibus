...
public class BasilPlant extends BushBlock implements IGrowable{
    ...
    protected IItemProvider getBaseSeedId() { return RegistryHandler.BASIL_SEED.get();
    }

    public BasilPlant(AbstractBlock.Properties p_i48421_1_) {
        super(p_i48421_1_);
